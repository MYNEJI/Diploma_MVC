        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Day = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingCarts_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubjectTeachers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupWeekdays", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupWeekdays_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupWeekdays_Weekdays_WeekdayId",
            ...
            migrationBuilder.InsertData(
                table: "Subjects",
                columns: new[] { "Id", "CategoryId", "Description", "ISBN", "ImageUrl", "ListPrice", "Price", "Price100", "Price50", "Title" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_SubjectTeacherId",
                table: "Groups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupWeekdays_GroupId",
                table: "GroupWeekdays",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupWeekdays_WeekdayId",
                table: "GroupWeekdays",
                column: "WeekdayId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCarts_SubjectId",
                table: "ShoppingCarts",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectTeachers_ApplicationUserId",
