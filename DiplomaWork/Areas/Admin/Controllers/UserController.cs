...
namespace DiplomaWork.Areas.Admin.Controllers
{
	...
	public class UserController : Controller
	{
		...
		public IActionResult RoleManagement(RoleManagementVM roleManagmentVM)
		{
			...
			{
				//a role was updated
				if (roleManagmentVM.ApplicationUser.Role == SD.Role_Manager)
				{
					applicationUser.CompanyId = roleManagmentVM.ApplicationUser.CompanyId;
				}
				if (oldRole == SD.Role_Manager)
				{
			...
			{
				if (oldRole == SD.Role_Manager && applicationUser.CompanyId != roleManagmentVM.ApplicationUser.CompanyId)
				{
					applicationUser.CompanyId = roleManagmentVM.ApplicationUser.CompanyId;
					_unitOfWork.ApplicationUser.Update(applicationUser);
					_unitOfWork.Save();
